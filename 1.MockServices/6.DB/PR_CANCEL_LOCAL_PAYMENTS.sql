CREATE OR REPLACE PROCEDURE PR_CANCEL_LOCAL_PAYMENTS (P_USER IN VARCHAR2 DEFAULT USER
)  AUTHID CURRENT_USER IS
/******************************************************************************
   NAME:       PR_CANCEL_LOCAL_PAYMENTS
   PURPOSE:    cancelar el pago en Local Payments
   ...
   AUTOMATICALLY AVAILABLE AUTO REPLACE KEYWORDS:
      OBJECT NAME:     PR_CANCEL_LOCAL_PAYMENTS
      SYSDATE:         09/09/2018
...
******************************************************************************/
  ...
  v_job_name                  varchar2(30) := 'PR_CANCEL_LOCAL_PAYMENTS';
