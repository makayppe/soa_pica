CREATE OR REPLACE PROCEDURE PR_CANCEL_CREDIT_CARD (P_USER IN VARCHAR2 DEFAULT USER
)  AUTHID CURRENT_USER IS
/******************************************************************************
   NAME:       PR_CANCEL_CREDIT_CARD
   PURPOSE:    cancelar la tarjeta crédito en Toolbox
   ...
   AUTOMATICALLY AVAILABLE AUTO REPLACE KEYWORDS:
      OBJECT NAME:     PR_CANCEL_CREDIT_CARD
      SYSDATE:         09/09/2018
...
******************************************************************************/
  ...
  v_job_name                  varchar2(30) := 'PR_CANCEL_CREDIT_CARD';
