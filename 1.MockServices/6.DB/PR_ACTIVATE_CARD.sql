CREATE OR REPLACE PROCEDURE PR_ACTIVATE_CARD (P_USER IN VARCHAR2 DEFAULT USER
)  AUTHID CURRENT_USER IS
/******************************************************************************
   NAME:       PR_ACTIVATE_CARD
   PURPOSE:    activar la tarjeta en ATP activation
...
******************************************************************************/
  ...
  v_job_name                  varchar2(30) := 'PR_ACTIVATE_CARD';
